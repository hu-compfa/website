...
class courses_filter(django_filters.FilterSet):
    course_containe = django_filters.CharFilter(
...
class Tutorial_filter(django_filters.FilterSet):
    tutorial_containe = django_filters.CharFilter(
        field_name="tutorials_name", lookup_expr="icontains"
    )
...
class Program_filter(django_filters.FilterSet):
    program_containe = django_filters.CharFilter(
        field_name="program_name", lookup_expr="icontains"
    )
