...
def major_page(request):
    ...
    return render(request, "website/major.html", context)
...
def level_page(request, m_name):
    ...
    return render(request, "website/level_page.html", context)
...
def semester_page(request, m_name, level):
    ...
    return render(request, "website/semester.html", context)
...
def courses_page(request, m_name, level, s_name):
    ...
    return render(request, "website/courses_page.html", context)
...
def teacher_page(request, m_name, level, s_name, c_name):
    ...
    return render(request, "website/teacher_page.html", context)
...
def courses_file_page(request, m_name, level, s_name, c_name, t_name):
    ...
    return render(request, "website/files_page.html", context)
...
def add_page_for_teacher(request):
        ...
        if "lecture" in request.POST:
            ...
            if lecture_form.is_valid():
                ...
                if len(teacher_have) > 0:
                    messages.warning(request, f"{teacher_have} are already upload")
                    return HttpResponseRedirect(request.META.get("HTTP_REFERER"))
    ...
    return render(request, "website/add_page_for_teacher.html", context)
...
def add_page_for_control(request):
    ...
    return render(request, "website/add_page_for_control.html", context)
...
def activities_page(request):
    ...
    return render(request, "website/activities_page.html", context)
...
def tutorial_teacher_page(request, tutorials_name):
    ...
    return render(request, "website/tutorial_teacher.html", context)
...
def tutorial_video_page(request, tutorials_name, tutorial_course_name, video_name):
    ...
    return render(request, "website/tutorials_video.html", context)
...
def suggandcomp(request):
    ...
    return render(request, "website/suggstion.html", context)
...
def program_page(request):
    ...
    return render(request, "website/programs_page.html", context)


def load_courses(request):
    le_id = request.GET.get("key")
    courses = Courses.objects.filter(level_id=le_id)
    return render(request, "website/load_courses.html", {"courses": courses})
